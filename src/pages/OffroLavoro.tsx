  ...
  return (
    <div className="container-page py-10">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <h1 className="heading-section">Offro lavoro</h1>
          <p className="text-body text-muted-foreground mt-1">Annunci pubblicati da rifugi che cercano personale</p>
        </div>
        <Link to="/pubblica-annuncio?type=offro" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-md font-medium hover:opacity-90 transition-opacity shrink-0">
          <Plus className="h-4 w-4" /> Pubblica un'offerta di lavoro
        </Link>
      </div>
